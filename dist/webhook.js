...
var get_payloads_1 = require("./get-payloads");
var RecipientEmail_1 = require("./components/emails/RecipientEmail");
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, get_payloads_1.getPayloadClient)()];
            case 1:
                payload = _c.sent();
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        ...
                        html: (0, RecipientEmail_1.ReceiptEmailHtml)({
                            date: new Date(),
                            email: user.email,
